  ...
  return (
    <div className="min-h-screen bg-[#f3f5ed] text-[#19241c] font-sans pb-28 selection:bg-[#a2d45e]/30 pt-28 sm:pt-36 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-full lg:w-[68%] xl:w-[62%] h-[840px] sm:h-[920px] pointer-events-none z-0 overflow-hidden select-none">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#f3f5ed] via-[#f3f5ed]/80 via-[18%] to-transparent to-[42%] w-full h-full" />
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute top-[38%] -left-40 w-[600px] h-[600px] bg-[#e2edd8]/50 rounded-full blur-3xl" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-4 items-center min-h-[480px] sm:min-h-[560px]">
          ...
          <div className="lg:col-span-6 space-y-6 lg:pr-2 z-10">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-[4.5rem] font-normal text-[#131f17] leading-[1.05] tracking-tight font-serif">
              Learning today.<br />
              <span className="italic text-[#243a29] font-serif font-normal">Sustaining tomorrow.</span>
            </h1>
          ...
          <div className="lg:col-span-6 relative flex items-center justify-start lg:justify-center min-h-[340px] sm:min-h-[420px]">
            ...
            <div className="relative lg:ml-[-50px] xl:ml-[-90px] bg-gradient-to-br from-white/45 via-white/25 to-white/15 backdrop-blur-2xl p-6 sm:p-7 rounded-[2.2rem] border-[1.5px] border-white/95 shadow-[inset_0_2px_4px_rgba(255,255,255,1),inset_0_-2px_4px_rgba(255,255,255,0.3),inset_2px_0_4px_rgba(255,255,255,0.8),0_25px_50px_-10px_rgba(0,30,15,0.25)] w-52 sm:w-60 z-20 transition-all duration-500 hover:-translate-y-1.5 hover:shadow-[inset_0_2px_4px_rgba(255,255,255,1),0_30px_60px_-10px_rgba(0,30,15,0.3)]">
              ...
              <h3 className="text-4xl sm:text-5xl font-serif text-[#0f1d13] mb-3 tracking-tight font-normal relative z-10 drop-shadow-[0_1px_1px_rgba(255,255,255,0.6)]">
                2024
              </h3>
        ...
        <div className="mt-8 sm:mt-12 p-3 sm:p-4 rounded-[2.8rem] bg-gradient-to-b from-white/40 via-white/25 to-white/15 backdrop-blur-3xl border-[1.5px] border-white/90 shadow-[inset_0_2px_4px_rgba(255,255,255,1),inset_0_-2px_4px_rgba(255,255,255,0.3),0_25px_60px_-10px_rgba(0,25,12,0.15)] relative z-20 transition-all duration-500">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-white/70 relative z-10">
            {[
              ...
              <div key={i} className="flex flex-col items-center text-center p-6 sm:p-8 group hover:bg-white/30 transition-all duration-500 rounded-[2.2rem] relative">
                
                {/* Real 3D Transparent Glass Lens Sphere */}
                <div className="w-16 h-16 rounded-full bg-gradient-to-b from-white/95 via-white/60 to-white/25 backdrop-blur-2xl border-[1.5px] border-white shadow-[inset_0_3px_6px_rgba(255,255,255,1),inset_0_-3px_5px_rgba(0,0,0,0.1),0_12px_24px_rgba(0,25,12,0.12)] flex items-center justify-center text-[#112417] mb-4 group-hover:scale-110 group-hover:shadow-[inset_0_3px_6px_rgba(255,255,255,1),0_16px_32px_rgba(0,25,12,0.18)] transition-all duration-500">
                  <ft.icon size={24} strokeWidth={1.5} />
                </div>
                
                <h4 className="text-[17px] font-serif font-normal text-[#101e14] mb-2 leading-snug whitespace-pre-line drop-shadow-[0_1px_1px_rgba(255,255,255,0.7)]">
                  {ft.title}
                </h4>
                
                <p className="text-[11.5px] text-[#3f5244] leading-relaxed whitespace-pre-line font-medium drop-shadow-[0_1px_1px_rgba(255,255,255,0.7)]">
                  {ft.desc}
                </p>
              </div>
            ))}
        ...
        <div className="mt-24 sm:mt-32 lg:mt-36 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center relative z-20">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <h2 className="text-4xl lg:text-5xl font-serif font-normal text-[#142218] leading-[1.12] tracking-tight">
              Empowering minds.<br />
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            {/* Top Wide Glass Card */}
            <div className="sm:col-span-2 relative h-52 sm:h-56 rounded-[2.2rem] overflow-hidden shadow-[inset_0_2px_4px_rgba(255,255,255,0.8),0_15px_35px_rgba(0,25,12,0.06)] group border-[1.5px] border-white/90 transition-all duration-500 hover:-translate-y-1">
              <img 
                src="/about/about2.png" 
                alt="Inspiring environments" 
                className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" 
              />
              <div className="absolute left-6 sm:left-8 bottom-6 flex items-center gap-3.5 bg-white/25 backdrop-blur-2xl border-[1.5px] border-white/80 shadow-[inset_0_1.5px_2px_rgba(255,255,255,0.9),0_10px_25px_rgba(0,0,0,0.2)] rounded-full p-2.5 pr-6 text-white transition-all duration-500 group-hover:bg-white/35">
                <div className="w-9 h-9 rounded-full bg-white/40 backdrop-blur-md border border-white/80 flex items-center justify-center shrink-0 shadow-sm">
                  <Building2 size={16} />
                </div>
            ...
            <div className="relative h-52 sm:h-56 rounded-[2.2rem] overflow-hidden shadow-[inset_0_2px_4px_rgba(255,255,255,0.8),0_15px_35px_rgba(0,25,12,0.06)] group border-[1.5px] border-white/90 transition-all duration-500 hover:-translate-y-1">
              <img 
              ...
              <div className="absolute inset-0 flex items-center justify-center p-6 text-center">
                <div className="flex flex-col items-center gap-3 bg-white/25 backdrop-blur-2xl border-[1.5px] border-white/80 shadow-[inset_0_1.5px_2px_rgba(255,255,255,0.9),0_10px_25px_rgba(0,0,0,0.2)] rounded-[1.8rem] p-5 w-full text-white transition-all duration-500 group-hover:bg-white/35">
                  <div className="w-9 h-9 rounded-full bg-white/40 backdrop-blur-md border border-white/80 flex items-center justify-center shrink-0 shadow-sm">
                    <Users size={16} />
                  </div>
            ...
            <div className="relative h-52 sm:h-56 rounded-[2.2rem] bg-gradient-to-br from-white/55 via-white/35 to-white/20 backdrop-blur-2xl border-[1.5px] border-white/95 shadow-[inset_0_2px_4px_rgba(255,255,255,1),inset_0_-2px_4px_rgba(255,255,255,0.3),0_20px_45px_rgba(0,25,12,0.06)] p-6 sm:p-7 flex flex-col justify-center transition-all duration-500 hover:-translate-y-1 hover:shadow-[inset_0_2px_4px_rgba(255,255,255,1),0_25px_50px_rgba(0,25,12,0.1)] group">
              <div className="w-14 h-14 rounded-full bg-gradient-to-b from-white/95 via-white/60 to-white/30 backdrop-blur-xl border-[1.5px] border-white shadow-[inset_0_2px_4px_rgba(255,255,255,1),0_8px_18px_rgba(0,25,12,0.1)] flex items-center justify-center text-[#162d1f] mb-4 group-hover:scale-110 transition-all duration-500">
                <FlaskConical size={22} strokeWidth={1.5} />
              </div>
              <p className="text-[#132216] text-[13.5px] font-medium leading-snug max-w-[190px] drop-shadow-[0_1px_1px_rgba(255,255,255,0.8)]">
                A dedicated STEM Learning Lab for hands-on, experiential learning.
              </p>
            </div>

            {/* Bottom Wide Glass Card */}
            <div className="sm:col-span-2 relative h-44 sm:h-48 rounded-[2.2rem] overflow-hidden shadow-[inset_0_2px_4px_rgba(255,255,255,0.8),0_15px_35px_rgba(0,25,12,0.06)] group border-[1.5px] border-white/90 transition-all duration-500 hover:-translate-y-1">
              <img 
                src="/about/about4.png" 
                alt="Innovative labs" 
                className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" 
              />
              <div className="absolute left-6 sm:left-8 bottom-6 flex items-center gap-3.5 bg-white/30 backdrop-blur-2xl border-[1.5px] border-white/80 shadow-[inset_0_1.5px_2px_rgba(255,255,255,0.9),0_10px_25px_rgba(0,0,0,0.2)] rounded-full p-2.5 pr-6 text-white transition-all duration-500 group-hover:bg-white/40">
                <div className="w-9 h-9 rounded-full bg-white/40 backdrop-blur-md border border-white/80 flex items-center justify-center shrink-0 shadow-sm">
                  <Leaf size={16} />
                </div>
        ...
        <div className="mt-24 sm:mt-32 lg:mt-36 relative z-20">
          <div className="flex flex-col sm:flex-row justify-between sm:items-end gap-6 mb-10">
            <div>
              <h2 className="text-4xl lg:text-5xl font-serif font-normal text-[#142218] leading-[1.12] tracking-tight">
                ...
                <span className="italic text-[#283d2d] font-serif font-normal">Driving meaningful change.</span>
              </h2>
            </div>
            
            <Link href="/projects" className="shrink-0">
              <button className="px-6 py-3 rounded-full bg-white/80 hover:bg-white backdrop-blur-xl border border-white/90 shadow-[inset_0_1.5px_2px_rgba(255,255,255,1),0_8px_20px_rgba(0,0,0,0.03)] text-[#162d1f] text-[11px] font-bold uppercase tracking-wider flex items-center gap-3 transition-all duration-500 hover:scale-[1.03] group cursor-pointer">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {[
              ...
              <div 
                key={i} 
                className="bg-gradient-to-b from-white/60 via-white/35 to-white/20 backdrop-blur-2xl border-[1.5px] border-white/95 rounded-[2rem] p-6 sm:p-7 flex flex-col justify-between shadow-[inset_0_2px_4px_rgba(255,255,255,1),inset_0_-1px_2px_rgba(255,255,255,0.3),0_15px_35px_rgba(0,0,0,0.04)] hover:-translate-y-1.5 hover:shadow-[inset_0_2px_4px_rgba(255,255,255,1),0_25px_50px_rgba(0,25,12,0.1)] transition-all duration-500 h-full group"
              >
                {/* 3D Glass Lens Icon */}
                <div className="w-14 h-14 rounded-full bg-gradient-to-b from-white/95 via-white/65 to-white/30 backdrop-blur-2xl border-[1.5px] border-white shadow-[inset_0_2px_4px_rgba(255,255,255,1),inset_0_-2px_4px_rgba(0,0,0,0.06),0_8px_18px_rgba(0,25,12,0.08)] flex items-center justify-center text-[#14261a] mb-6 shrink-0 group-hover:scale-110 transition-all duration-500">
                  <obj.icon size={22} strokeWidth={1.5} />
                </div>
                <div>
                  <div className="text-[11px] font-bold text-[#637567] uppercase tracking-widest mb-1.5">
                    {obj.num}
                  </div>
                  <h4 className="text-[17px] font-serif font-semibold text-[#142217] mb-2 leading-snug whitespace-pre-line drop-shadow-[0_1px_1px_rgba(255,255,255,0.8)]">
                    {obj.title}
                  </h4>
                  <p className="text-[12px] text-[#4d5e51] leading-[1.65] font-normal">
                    {obj.desc}
                  </p>
                </div>
              </div>
        ...
        <div className="mt-24 sm:mt-32 lg:mt-36 relative z-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
            ...
            <div className="lg:col-span-4 rounded-[2rem] bg-gradient-to-br from-white/60 via-white/40 to-white/20 backdrop-blur-2xl border-[1.5px] border-white/95 shadow-[inset_0_2px_4px_rgba(255,255,255,1),0_20px_45px_rgba(0,25,12,0.05)] p-7 sm:p-8 flex flex-col justify-between relative overflow-hidden min-h-[460px] group transition-all duration-500 hover:-translate-y-1.5 hover:shadow-[inset_0_2px_4px_rgba(255,255,255,1),0_28px_55px_rgba(0,25,12,0.1)]">
              <div className="relative z-10">
                <div className="flex items-center gap-1.5 mb-5">
                  <Leaf size={13} className="text-[#2d5a3c] fill-[#2d5a3c]" />
                  <span className="text-[10.5px] font-bold tracking-[0.18em] text-[#3d5042] uppercase">
                    KEY INITIATIVES
                  </span>
                </div>
                <h3 className="text-3xl font-serif font-normal text-[#122016] tracking-tight mb-3 drop-shadow-[0_1px_1px_rgba(255,255,255,0.8)]">
                  STEM Learning Lab
                </h3>
              ...
              <div className="w-9 h-9 rounded-full bg-white border border-white/90 shadow-[0_4px_12px_rgba(0,0,0,0.08)] flex items-center justify-center text-[#14261a] hover:scale-110 transition-all duration-500 cursor-pointer z-10 mt-6 shrink-0">
                <ArrowRight size={13} />
              </div>

              {/* Microscope Image on Bottom Right */}
              <div className="absolute -bottom-2 -right-4 w-[78%] max-w-[250px] pointer-events-none group-hover:scale-105 transition-transform duration-700 z-0">
                <img 
                  src="/about/a1.png" 
            ...
            <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                <div 
                  key={i} 
                  className="rounded-[2rem] overflow-hidden relative min-h-[220px] sm:min-h-[230px] border-[1.5px] border-white/95 shadow-[inset_0_2px_4px_rgba(255,255,255,0.9),0_15px_35px_rgba(0,25,12,0.05)] bg-white/40 backdrop-blur-xl flex flex-col justify-between p-7 sm:p-8 group transition-all duration-500 hover:-translate-y-1.5 hover:shadow-[inset_0_2px_4px_rgba(255,255,255,1),0_25px_45px_rgba(0,25,12,0.1)]"
                >
                  <img 
                    src={item.img} 
                    alt={item.title} 
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-[#f0f3eb]/95 via-[#f0f3eb]/70 to-transparent" />
                  
                  <div className="relative z-10">
                    <h4 className="text-[17px] font-serif font-semibold text-[#122016] mb-2 leading-snug drop-shadow-[0_1px_1px_rgba(255,255,255,0.8)]">
                      {item.title}
                    </h4>
                    <p className="text-[12px] text-[#445548] leading-relaxed max-w-[230px] font-normal drop-shadow-[0_1px_1px_rgba(255,255,255,0.7)]">
                      {item.desc}
                    </p>
                  </div>
                  
                  <div className="relative z-10 w-9 h-9 rounded-full bg-white border border-white/90 shadow-[0_4px_12px_rgba(0,0,0,0.08)] flex items-center justify-center text-[#14261a] hover:scale-110 transition-all duration-500 cursor-pointer shrink-0 mt-4">
                    <ArrowRight size={13} />
                  </div>
                </div>
              ))}
        ...
        <div className="mt-16 sm:mt-24 mb-12 rounded-[2.4rem] bg-gradient-to-b from-white/55 via-white/40 to-white/20 backdrop-blur-3xl border-[1.5px] border-white/95 shadow-[inset_0_2px_4px_rgba(255,255,255,1),0_20px_45px_rgba(0,25,12,0.05)] p-5 sm:p-6 grid grid-cols-1 lg:grid-cols-12 gap-6 items-center relative z-20 transition-all duration-500">
          ...
          <div className="lg:col-span-3 h-44 sm:h-48 rounded-[2rem] overflow-hidden border border-white/80 shadow-sm">
            <img 
              src="/about/a5.png" 
              alt="Lush nature" 
          ...
          <div className="lg:col-span-6 space-y-3 px-1 sm:px-2">
            <div className="flex items-center gap-1.5">
              <Leaf size={12} className="text-[#2d5a3c] fill-[#2d5a3c]" />
              <span className="text-[10px] font-bold tracking-[0.2em] text-[#556758] uppercase">
                SOCIAL IMPACT
              </span>
            </div>
            
            <h2 className="text-3xl sm:text-4xl font-serif font-normal text-[#122016] leading-tight tracking-tight whitespace-pre-line drop-shadow-[0_1px_1px_rgba(255,255,255,0.7)]">
          ...
          {/* Right Glass Card */}
          <div className="lg:col-span-3 p-6 rounded-[2rem] bg-gradient-to-b from-white/75 via-white/50 to-white/30 backdrop-blur-2xl border-[1.5px] border-white/95 shadow-[inset_0_2px_4px_rgba(255,255,255,1),0_12px_28px_rgba(0,25,12,0.05)] flex flex-col items-center justify-center text-center transition-all duration-500 hover:-translate-y-1 min-h-[170px]">
            <div className="w-13 h-13 rounded-full bg-gradient-to-b from-white/95 via-white/60 to-white/30 backdrop-blur-xl border border-white shadow-[inset_0_2px_3px_rgba(255,255,255,1),0_6px_14px_rgba(0,20,10,0.08)] flex items-center justify-center text-[#162d1f] mb-3.5">
              <HeartHandshake size={22} strokeWidth={1.5} />
            </div>
            <p className="text-[12px] font-semibold text-[#182b1d] leading-relaxed drop-shadow-[0_1px_1px_rgba(255,255,255,0.8)]">
