      ...
      <div className="relative max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 min-h-[500px] lg:min-h-[600px] xl:min-h-[650px] items-center pb-12 lg:pb-0">
          ...
          <div className="lg:col-span-7 space-y-6 lg:pr-10 pt-4">
            ...
            <p className="text-[#405245] dark:text-slate-300 text-sm leading-[1.7] max-w-xl font-normal">
              {event.description}
            </p>
            ...
            <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-3 sm:gap-4 pt-2 pb-4">
              <div className="flex items-center gap-3 bg-white/70 dark:bg-[#0b1c14]/80 backdrop-blur-md px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-2xl border border-[#d2e0d3]/60 dark:border-[#183a27] shadow-xs">
                ...
                <div>
                  <div className="text-xs sm:text-[13px] font-bold text-[#19241c] dark:text-white">14 - 15</div>
                  <div className="text-[10px] sm:text-[11px] text-[#556758] dark:text-slate-400 font-medium">March 2025</div>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-white/70 dark:bg-[#0b1c14]/80 backdrop-blur-md px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-2xl border border-[#d2e0d3]/60 dark:border-[#183a27] shadow-xs">
                <div className="text-[#2d5a3c] dark:text-[#a2d45e] shrink-0"><Clock size={18} /></div>
                <div>
                  <div className="text-xs sm:text-[13px] font-bold text-[#19241c] dark:text-white">09:30 AM</div>
                  <div className="text-[10px] sm:text-[11px] text-[#556758] dark:text-slate-400 font-medium">Onwards</div>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-white/70 dark:bg-[#0b1c14]/80 backdrop-blur-md px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-2xl border border-[#d2e0d3]/60 dark:border-[#183a27] shadow-xs">
                <div className="text-[#2d5a3c] dark:text-[#a2d45e] shrink-0"><MapPin size={18} /></div>
                <div>
                  <div className="text-xs sm:text-[13px] font-bold text-[#19241c] dark:text-white truncate max-w-[110px] sm:max-w-none">Trivandrum</div>
                  <div className="text-[10px] sm:text-[11px] text-[#556758] dark:text-slate-400 font-medium">Kerala, India</div>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-white/70 dark:bg-[#0b1c14]/80 backdrop-blur-md px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-2xl border border-[#d2e0d3]/60 dark:border-[#183a27] shadow-xs">
                <div className="text-[#2d5a3c] dark:text-[#a2d45e] shrink-0"><Users size={18} /></div>
                <div>
                  <div className="text-xs sm:text-[13px] font-bold text-[#19241c] dark:text-white">Hybrid</div>
                  <div className="text-[10px] sm:text-[11px] text-[#556758] dark:text-slate-400 font-medium">Mode</div>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-8 space-y-16">
            ...
            <section>
              ...
              <div className="space-y-4 text-[#445548] dark:text-slate-300 text-sm leading-[1.8]">
                <p>
            ...
            <section className="bg-white dark:bg-[#0b1c14] rounded-[2rem] p-8 border border-[#e8efe9] dark:border-[#183a27] shadow-[0_4px_20px_rgba(0,0,0,0.02)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.3)]">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-6 sm:gap-4 divide-y-0 sm:divide-y-0 sm:divide-x divide-[#e8efe9] dark:divide-[#183a27]">
                {[
            ...
            {/* Who Should Attend */}
            <section>
              <h2 className="text-2xl sm:text-3xl font-serif text-[#122016] dark:text-white mb-6">Who Should Attend</h2>
              <div className="flex flex-wrap gap-4 justify-center sm:justify-start">
                {[
                  ...
                  <div key={idx} className="flex flex-col items-center justify-center text-center w-[120px] h-[110px] rounded-[1.5rem] bg-white dark:bg-[#0b1c14] border border-[#e8efe9] dark:border-[#183a27] hover:border-[#2d5a3c]/30 dark:hover:border-[#a2d45e]/40 shadow-[0_2px_10px_rgba(0,0,0,0.02)] transition-colors group">
                    <item.icon size={22} strokeWidth={1.5} className="text-[#2d5a3c] dark:text-[#a2d45e] mb-2 group-hover:scale-110 transition-transform" />
                    <span className="text-[10.5px] font-semibold text-[#3b4c40] dark:text-slate-300 whitespace-pre-line leading-tight">{item.label}</span>
                  </div>
                ))}
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                {/* Speaker 1 */}
                <div className="flex items-center gap-5 p-5 rounded-[1.8rem] bg-white dark:bg-[#0b1c14] border border-[#e8efe9] dark:border-[#183a27] shadow-[0_2px_15px_rgba(0,0,0,0.02)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.3)] hover:-translate-y-1 transition-transform duration-300">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2 mb-0.5">
                      <h4 className="text-[16px] font-bold text-[#19241c] dark:text-white">Prof. Jan De Waters</h4>
                    </div>
                    ...
                    <p className="text-[12px] text-[#556758] dark:text-slate-300 font-medium leading-snug">Clarkson University, USA</p>
                    <p className="text-[11px] text-[#6c7d70] dark:text-slate-400 leading-tight pt-1">Professor and expert in educational technology and sustainable learning systems.</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-5 p-5 rounded-[1.8rem] bg-white dark:bg-[#0b1c14] border border-[#e8efe9] dark:border-[#183a27] shadow-[0_2px_15px_rgba(0,0,0,0.02)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.3)] hover:-translate-y-1 transition-transform duration-300">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2 mb-0.5">
                      <h4 className="text-[16px] font-bold text-[#19241c] dark:text-white">Sri. V. Sivankutty</h4>
                    </div>
                    <span className="inline-block px-2 py-0.5 rounded text-[9.5px] font-bold uppercase tracking-wider bg-[#f3efe6] dark:bg-[#2c2413] text-[#6b5833] dark:text-[#e0c27a] mb-1">
                      Inaugurator
                    </span>
                    <p className="text-[12px] text-[#556758] dark:text-slate-300 font-medium leading-snug">Hon'ble Minister for Education, Kerala</p>
                    <p className="text-[11px] text-[#6c7d70] dark:text-slate-400 leading-tight pt-1">Inaugurating the conference and championing quality education for all.</p>
                  </div>
                </div>
              ...
              <div className="flex justify-center sm:justify-start">
                <button className="px-5 py-2.5 rounded-full bg-white dark:bg-[#0b1c14] border border-[#d2e0d3] dark:border-[#183a27] text-[#1b3726] dark:text-[#a2d45e] text-[11px] font-bold flex items-center gap-2 hover:bg-[#f3f6f1] dark:hover:bg-[#11261a] transition-colors shadow-sm cursor-pointer">
                  ...
                  <div key={idx} className="flex items-center justify-between p-4 rounded-2xl bg-white dark:bg-[#11261a] border border-[#e4ede6] dark:border-[#1e422c] hover:border-[#c9dacd] hover:shadow-sm transition-all group cursor-pointer">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-[#6c7d70] dark:text-slate-400">{doc.size}</p>
                      </div>
                    </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-24">
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl sm:text-3xl font-serif text-[#122016] dark:text-white">You May Also Be Interested In</h2>
            <Link href="/events" className="text-[12px] font-bold text-[#2d5a3c] dark:text-[#a2d45e] hover:text-[#1b3726] dark:hover:text-[#b8e874] flex items-center gap-1.5 transition-colors group">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 relative">
            {[
              ...
              <Link href={`/events/1`} key={idx} className="group flex flex-col bg-white dark:bg-[#0b1c14] rounded-2xl border border-[#e8efe9] dark:border-[#183a27] overflow-hidden hover:shadow-[0_8px_25px_rgba(0,0,0,0.04)] dark:hover:shadow-[0_8px_25px_rgba(0,0,0,0.3)] transition-all duration-300">
                <div className="h-36 w-full overflow-hidden bg-slate-100 dark:bg-[#05110a]">
                ...
                <div className="p-5 flex-1 flex flex-col justify-between">
                  <div>
                    <span className="inline-block px-2 py-0.5 rounded text-[9px] font-bold uppercase tracking-widest bg-[#eaf1e4] dark:bg-[#11261a] text-[#2d5a3c] dark:text-[#a2d45e] mb-3">
                      {evt.category}
                    </span>
                    <h3 className="text-[14px] font-bold text-[#19241c] dark:text-white leading-snug mb-4 group-hover:text-[#2d5a3c] dark:group-hover:text-[#a2d45e] transition-colors line-clamp-2">
                      {evt.title}
                    </h3>
                  </div>
                  <div className="text-[11.5px] font-medium text-[#6c7d70] dark:text-slate-400">
                    {evt.date}
                  </div>
                </div>
              </Link>
        ...
        <div className="rounded-[2rem] bg-[#eef1eb] dark:bg-[#0b1c14] border border-[#e4ede6] dark:border-[#183a27] flex flex-col sm:flex-row items-center justify-between p-6 sm:p-8 md:p-10 gap-8 relative overflow-hidden transition-all duration-300">

          {/* Left visual */}
          <div className="hidden sm:block absolute left-0 bottom-0 w-[40%] h-[120%] opacity-90 dark:opacity-40 pointer-events-none origin-bottom-left scale-110">
            <img
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#eef1eb]/70 dark:via-[#0b1c14]/80 to-[#eef1eb] dark:to-[#0b1c14]" />
          </div>

          <div className="w-full sm:w-1/2 sm:ml-auto relative z-10 space-y-2">
            <h3 className="text-2xl sm:text-3xl font-serif text-[#122016] dark:text-white">Stay Updated</h3>
            <p className="text-[12.5px] text-[#556758] dark:text-slate-300 max-w-sm pb-2">
          ...
          <div className="w-full sm:w-auto relative z-10 shrink-0">
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="bg-white dark:bg-[#05110a] border border-white dark:border-[#183a27] rounded-full p-1.5 pl-5 pr-1.5 flex items-center shadow-sm w-full sm:w-[320px]">
                <input
                  type="email"
                  value={email}
                  ...
                  className="text-[13px] text-slate-800 dark:text-white placeholder:text-[#8a9d90] dark:placeholder-slate-500 bg-transparent outline-none flex-1 font-medium min-w-0"
                />
                <button
                  type="submit"
                  className="px-5 py-2.5 rounded-full bg-[#3d5b45] dark:bg-[#a2d45e] hover:bg-[#2d4734] dark:hover:bg-[#b8e874] text-white dark:text-[#031008] text-[11px] font-bold flex items-center gap-2 transition-colors cursor-pointer shrink-0"
                >
                  <span>Subscribe</span>
                  <ArrowRight size={14} />
                </button>
          ...
          {/* Right decoration */}
          <div className="absolute right-0 bottom-0 pointer-events-none opacity-40 dark:opacity-20">
