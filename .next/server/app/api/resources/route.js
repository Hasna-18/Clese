"use strict";(()=>{var t={};t.id=193,t.ids=[193],t.modules={399:t=>{t.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:t=>{t.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8678:t=>{t.exports=import("pg")},7006:(t,e,r)=>{r.a(t,async(t,a)=>{try{r.r(e),r.d(e,{originalPathname:()=>g,patchFetch:()=>l,requestAsyncStorage:()=>c,routeModule:()=>d,serverHooks:()=>_,staticGenerationAsyncStorage:()=>E});var i=r(9303),s=r(8716),n=r(670),o=r(50),u=t([o]);o=(u.then?(await u)():u)[0];let d=new i.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/resources/route",pathname:"/api/resources",filename:"route",bundlePath:"app/api/resources/route"},resolvedPagePath:"C:\\Users\\VIGNESH\\HASNA\\universe\\universe\\app\\api\\resources\\route.js",nextConfigOutput:"",userland:o}),{requestAsyncStorage:c,staticGenerationAsyncStorage:E,serverHooks:_}=d,g="/api/resources/route";function l(){return(0,n.patchFetch)({serverHooks:_,staticGenerationAsyncStorage:E})}a()}catch(t){a(t)}})},50:(t,e,r)=>{r.a(t,async(t,a)=>{try{r.r(e),r.d(e,{DELETE:()=>d,GET:()=>o,POST:()=>u,PUT:()=>l});var i=r(7070),s=r(53),n=t([s]);async function o(){try{let t=await (0,s.jh)();return i.NextResponse.json(t)}catch(t){return i.NextResponse.json({error:t.message},{status:500})}}async function u(t){try{let e=await t.json(),r=await (0,s.rp)(e);return i.NextResponse.json(r)}catch(t){return i.NextResponse.json({error:t.message},{status:500})}}async function l(t){try{let e=await t.json();if(!e.id)throw Error("ID is required");let r=await (0,s.id)(e.id,e);return i.NextResponse.json(r)}catch(t){return i.NextResponse.json({error:t.message},{status:500})}}async function d(t){try{let{searchParams:e}=new URL(t.url),r=e.get("id");if(!r)throw Error("ID is required");let a=await (0,s.fg)(r);return i.NextResponse.json(a)}catch(t){return i.NextResponse.json({error:t.message},{status:500})}}s=(n.then?(await n)():n)[0],a()}catch(t){a(t)}})},53:(t,e,r)=>{r.a(t,async(t,a)=>{try{r.d(e,{Bt:()=>c,Y:()=>E,dD:()=>y,eJ:()=>d,fg:()=>p,id:()=>R,jB:()=>w,jh:()=>m,kN:()=>h,lg:()=>g,rp:()=>T,uB:()=>_,vP:()=>l,vw:()=>u,yQ:()=>f});var i=r(8678),s=t([i]);i=(s.then?(await s)():s)[0];let D=globalThis._pgPool;function n(){if(!D){let t=process.env.DATABASE_URL?process.env.DATABASE_URL.trim():null;if(!t)throw Error("DATABASE_URL is not set.");D=new i.Pool({connectionString:t,ssl:{rejectUnauthorized:!1},connectionTimeoutMillis:15e3,idleTimeoutMillis:3e4,max:10})}return D}async function o(){let t=n();try{await t.query(`
  ...
  `;try{let t=(await e.query($,[r||"EVENTS",a||"Discover. Learn.\nConnect.",i||"",s||"/events/e1.png",o||"FEATURED INITIATIVE",u||"STEM 4 Girls",l||"",d||"/events/e1.png",c||"#",_||"56+",g||"Gifted Students<br/>Supported",y||"44",f||"Schools in<br/>Kerala",w||"41",h||"Educational<br/>Districts",m||"6+",T||"Programmes<br/>Organized",R||"Stay Updated",p||"",D])).rows[0],n=[];return t.featured_initiatives&&(n="string"==typeof t.featured_initiatives?JSON.parse(t.featured_initiatives):t.featured_initiatives),{id:t.id,heroTag:t.hero_tag,heroTitle:t.hero_title,heroSubtitle:t.hero_subtitle,heroImage:t.hero_image,featuredTag:t.featured_tag,featuredTitle:t.featured_title,featuredSubtitle:t.featured_subtitle,featuredImage:t.featured_image,featuredLink:t.featured_link,featuredInitiatives:n,stat1Number:t.stat1_number,stat1Text:t.stat1_text,stat2Number:t.stat2_number,stat2Text:t.stat2_text,stat3Number:t.stat3_number,stat3Text:t.stat3_text,stat4Number:t.stat4_number,stat4Text:t.stat4_text,newsletterTitle:t.newsletter_title,newsletterText:t.newsletter_text}}catch(t){throw console.error("Error updating event settings in DB:",t),t}}async function y(){await o();let t=n();try{return(await t.query("SELECT * FROM news ORDER BY id DESC")).rows.map(t=>({id:t.id,tag:t.tag,category:t.category,title:t.title,desc:t.desc,date:t.date,imageUrl:t.image_url}))}catch(t){throw console.error("Error fetching news:",t),t}}async function f(t){await o();let e=n(),{tag:r,category:a,title:i,desc:s,date:u,imageUrl:l}=t,d=`
    ...
    VALUES ($1, $2, $3, $4, $5, $6)
    RETURNING *;
  `;try{let t=(await e.query(d,[r,a,i,s,u,l])).rows[0];return{id:t.id,tag:t.tag,category:t.category,title:t.title,desc:t.desc,date:t.date,imageUrl:t.image_url}}catch(t){throw console.error("Error inserting news:",t),t}}async function w(t,e){await o();let r=n(),{tag:a,category:i,title:s,desc:u,date:l,imageUrl:d}=e,c=`
    UPDATE news
