"use strict";(()=>{var t={};t.id=634,t.ids=[634],t.modules={399:t=>{t.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:t=>{t.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8678:t=>{t.exports=import("pg")},3901:(t,e,r)=>{r.a(t,async(t,a)=>{try{r.r(e),r.d(e,{originalPathname:()=>g,patchFetch:()=>l,requestAsyncStorage:()=>c,routeModule:()=>d,serverHooks:()=>_,staticGenerationAsyncStorage:()=>E});var i=r(9303),s=r(8716),n=r(670),o=r(2622),u=t([o]);o=(u.then?(await u)():u)[0];let d=new i.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/news/route",pathname:"/api/news",filename:"route",bundlePath:"app/api/news/route"},resolvedPagePath:"C:\\Users\\VIGNESH\\HASNA\\universe\\universe\\app\\api\\news\\route.js",nextConfigOutput:"",userland:o}),{requestAsyncStorage:c,staticGenerationAsyncStorage:E,serverHooks:_}=d,g="/api/news/route";function l(){return(0,n.patchFetch)({serverHooks:_,staticGenerationAsyncStorage:E})}a()}catch(t){a(t)}})},2622:(t,e,r)=>{r.a(t,async(t,a)=>{try{r.r(e),r.d(e,{DELETE:()=>d,GET:()=>o,POST:()=>u,PUT:()=>l});var i=r(7070),s=r(53),n=t([s]);async function o(){try{let t=await (0,s.dD)();return i.NextResponse.json(t)}catch(t){return i.NextResponse.json({error:t.message},{status:500})}}async function u(t){try{let e=await t.json(),r=await (0,s.yQ)(e);return i.NextResponse.json(r)}catch(t){return i.NextResponse.json({error:t.message},{status:500})}}async function l(t){try{let e=await t.json();if(!e.id)throw Error("ID is required");let r=await (0,s.jB)(e.id,e);return i.NextResponse.json(r)}catch(t){return i.NextResponse.json({error:t.message},{status:500})}}async function d(t){try{let{searchParams:e}=new URL(t.url),r=e.get("id");if(!r)throw Error("ID is required");let a=await (0,s.kN)(r);return i.NextResponse.json(a)}catch(t){return i.NextResponse.json({error:t.message},{status:500})}}s=(n.then?(await n)():n)[0],a()}catch(t){a(t)}})},53:(t,e,r)=>{r.a(t,async(t,a)=>{try{r.d(e,{Bt:()=>c,Y:()=>E,dD:()=>y,eJ:()=>d,fg:()=>p,id:()=>R,jB:()=>f,jh:()=>m,kN:()=>h,lg:()=>g,rp:()=>T,uB:()=>_,vP:()=>l,vw:()=>u,yQ:()=>w});var i=r(8678),s=t([i]);i=(s.then?(await s)():s)[0];let D=globalThis._pgPool;function n(){if(!D){let t=process.env.DATABASE_URL?process.env.DATABASE_URL.trim():null;if(!t)throw Error("DATABASE_URL is not set.");D=new i.Pool({connectionString:t,ssl:{rejectUnauthorized:!1},connectionTimeoutMillis:15e3,idleTimeoutMillis:3e4,max:10})}return D}async function o(){let t=n();try{await t.query(`
