"use strict";(()=>{var t={};t.id=531,t.ids=[531],t.modules={399:t=>{t.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:t=>{t.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8678:t=>{t.exports=import("pg")},8910:(t,e,r)=>{r.a(t,async(t,a)=>{try{r.r(e),r.d(e,{originalPathname:()=>g,patchFetch:()=>u,requestAsyncStorage:()=>c,routeModule:()=>d,serverHooks:()=>_,staticGenerationAsyncStorage:()=>E});var i=r(9303),s=r(8716),n=r(670),o=r(9125),l=t([o]);o=(l.then?(await l)():l)[0];let d=new i.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/event-settings/route",pathname:"/api/event-settings",filename:"route",bundlePath:"app/api/event-settings/route"},resolvedPagePath:"C:\\Users\\VIGNESH\\HASNA\\universe\\universe\\app\\api\\event-settings\\route.js",nextConfigOutput:"",userland:o}),{requestAsyncStorage:c,staticGenerationAsyncStorage:E,serverHooks:_}=d,g="/api/event-settings/route";function u(){return(0,n.patchFetch)({serverHooks:_,staticGenerationAsyncStorage:E})}a()}catch(t){a(t)}})},9125:(t,e,r)=>{r.a(t,async(t,a)=>{try{r.r(e),r.d(e,{GET:()=>o,POST:()=>l,PUT:()=>u});var i=r(7070),s=r(53),n=t([s]);async function o(){try{let t=await (0,s.uB)();return i.NextResponse.json(t||{})}catch(t){return console.error("Error fetching event settings:",t),i.NextResponse.json({error:"Failed to fetch settings"},{status:500})}}async function l(t){try{let e=await t.json(),r=await (0,s.lg)(e);return i.NextResponse.json(r)}catch(t){return console.error("Error updating event settings:",t),i.NextResponse.json({error:t.message||"Failed to update settings"},{status:500})}}async function u(t){return l(t)}s=(n.then?(await n)():n)[0],a()}catch(t){a(t)}})},53:(t,e,r)=>{r.a(t,async(t,a)=>{try{r.d(e,{Bt:()=>c,Y:()=>E,dD:()=>y,eJ:()=>d,fg:()=>p,id:()=>R,jB:()=>w,jh:()=>m,kN:()=>h,lg:()=>g,rp:()=>T,uB:()=>_,vP:()=>u,vw:()=>l,yQ:()=>f});var i=r(8678),s=t([i]);i=(s.then?(await s)():s)[0];let D=globalThis._pgPool;function n(){if(!D){let t=process.env.DATABASE_URL?process.env.DATABASE_URL.trim():null;if(!t)throw Error("DATABASE_URL is not set.");D=new i.Pool({connectionString:t,ssl:{rejectUnauthorized:!1},connectionTimeoutMillis:15e3,idleTimeoutMillis:3e4,max:10})}return D}async function o(){let t=n();try{await t.query(`
